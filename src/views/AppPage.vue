  ...
  <div class="app-page">
    ...
    <nav class="nav">
      <div class="nav-container">
        <router-link to="/" class="btn-back"> ← {{ t('app-back') }} </router-link>
        <h2>{{ t('app-title') }}</h2>
      </div>
    </nav>
    ...
    <div class="container">
      <div class="app-content">
        ...
        <section class="action-section">
          ...
          <button v-if="processedFiles.length > 0" class="btn-download" @click="downloadAll">
            {{ t('app-download') }}
          </button>
        </section>
        ...
        <section v-if="processedFiles.length > 0" class="results-section">
          ...
          <div class="results-list">
            <div v-for="(file, index) in processedFiles" :key="index" class="result-item">
              <span>{{ file.name }}</span>
              <button class="btn-download-single" @click="downloadFile(file)">
                ⬇️ {{ t('app-download') }}
              </button>
            </div>
          </div>
